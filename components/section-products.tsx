    ...
    <section className="border-y border-black/10 py-32">
      <div className="container-luxe">
        <div className="mb-20 flex flex-wrap items-end justify-between gap-8">
          <div>
            <p className="kicker text-xs tracking-[0.3em] text-black/60">
              SIGNATURE LINE
            </p>
            <h2 className="mt-6 font-display text-5xl leading-[0.9] md:text-7xl">Shop The Collection</h2>
            <p className="mt-6 max-w-xl text-sm uppercase leading-relaxed tracking-[0.1em] text-black/50">
            ...
            <article key={product.slug} className="group relative">
              ...
              <div className="mt-8 flex items-start justify-between gap-6">
                <div>
                  ...
                  <p className="mt-2 text-xs uppercase tracking-[0.2em] text-black/50">{product.volume}</p>
                </div>
                <p className="text-sm font-medium tracking-[0.1em]">{product.price}</p>
              </div>
              <button className="mt-8 w-full border border-black/20 py-3 text-xs uppercase tracking-[0.2em] transition-all hover:border-black hover:bg-black hover:text-white">
                Add to Cart
              </button>
            </article>
          ))}
